...
который готов поделиться с вами сокровищами .Во второй -жадный и голодный дракон,
...
def chooseCave():
    ...
    while cave!='1' and cave!='2':
        print('В какую пещеру вы пойдете ?(нажмите клавищу 1 или 2)')
        cave=input()
    return cave
def checkCave(chosenCave):
    print ('Вы приближаетесь к пещере...')
    time.sleep(2)
    print('Ее темнота засталяет вас дрожать от страха...')
    time.sleep(2)
...
playAgain='да'
while playAgain=='да'or playAgain=='д'or playAgain=='':
    displayIntro()
